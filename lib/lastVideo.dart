...
class LastVideoScreen extends StatefulWidget {
  const LastVideoScreen({Key? key, required this.videoKey,required this.selectedVideoIndex}) : super(key: key);
  final String videoKey;
  final int selectedVideoIndex;

  @override
  _LastVideoScreenState createState() => _LastVideoScreenState();
}

class _LastVideoScreenState extends State<LastVideoScreen> {
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (contex)=> LastVideoScreen(videoKey: videoUrls[index],selectedVideoIndex: index),));
                        },
                        child: Container(
                          width: 250,
                          child: VideoCardColumn(
                            videoTitle: titless[0],
