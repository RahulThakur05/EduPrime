...
class ChemVideoScreen extends StatefulWidget {
  const ChemVideoScreen({Key? key, required this.videoKey,required this.selectedVideoIndex}) : super(key: key);
  final String videoKey;
  final int selectedVideoIndex;

  @override
  _ChemVideoScreenState createState() => _ChemVideoScreenState();
}

class _ChemVideoScreenState extends State<ChemVideoScreen> {
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (contex)=> ChemVideoScreen(videoKey: videoUrls[index],selectedVideoIndex: index),));
                        },
                        child: Container(
                          width: 250,
